...
ffmpeg -y -i baboon.png -vf "scale=in_range=full:out_range=full,format=rgb24" -f rawvideo -pix_fmt gbrp baboon_512x512.rgb && mv baboon_512x512.rgb baboon_512x512.gbr
